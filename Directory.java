...
public class Directory extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fm = new filterMap(Directory.this);
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        if (marker.equals(StadiumM))
        {
            ...
            if(routeInfo == true){
                customDialog cd = new customDialog(Directory.this);
                cd.show();
            }
            else {
                routeInfo = true;
